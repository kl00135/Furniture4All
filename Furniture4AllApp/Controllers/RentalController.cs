...
using Furniture4All.DAL;
using Furniture4All.Models;
...
namespace Furniture4AllApp.Controllers
    {
        ...
        public class RentalController
        {
            ...
            /// <summary>
            /// This method will validate the checks on the rental transaction.
            /// It will return a list of error messages or an empty list of errors means success.
            /// </summary>
            /// <param name="rental"></param>
            /// <returns>The error messages constructed.</returns>
            private List<string> ValidateRental(RentalTransaction rental)
            {
                ...
                {
                    errors.Add("An employee is assigned to this transaction.");
                }
